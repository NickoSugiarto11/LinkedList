...
void main() {
  ...
  ll.insertFront(10);
  ll.insertFront(30);
  print("Operasi Menambahkan Data di Depan Linked List:");
  ll.PrintList();
  ll.InsertBack(5);
  print("Operasi Menambahkan Data di Belakang Linked List:");

  print("Operasi Menambahkan Data Setelah Node Tertentu:");
  ll.InsertAfter(ll.head!.next!.next!, 20);
  ll.PrintList();
  print("Operasi Menghapus Data:");
